...
@section('content')
    <div class="part-1-body flex-centered">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="lipids-view-exercise-pe" class="input-label">R.I.R.: </label>
                        <span class="lipids-view-exercise-pe text-cye-default wrap-text" id="lipids-view-exercise-pe"
                            name="lipids-view-exercise-pe">
                        </span>
                    </div>
        ...
        <div class="modal" tabindex="-1" id="edit-day-pe-modal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
